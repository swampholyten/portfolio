const projects = [
	{
		name: "Patente Plus",
		image: "/projects/patente-plus.jpeg",
				...
				<div className="mt-10 md:mt-16 lg:mt-20">
					{projects.map(({ name, image, url }) => (
						<a
							href={url}
							key={name}
							className="border-t py-6 md:py-8 lg:py-10 last:border-b border-foreground/50 border-dotted flex flex-col relative group/project"
						>
							<div className="absolute bottom-0 left-0 w-full h-0 group-hover/project:h-full transition-all duration-500 bg-foreground/10"></div>
